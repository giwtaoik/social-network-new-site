<?php
...

	{
        ...
        //euresi tou arithmou twn requests pou exei o xristis
        ...
        //elegxos ean uparxoun sfalmata na ta emfanisei ston xristi
...

        {
            ...
            if($err==1)
                ...
                $err="Παρακαλώ επιλέξτε φάκελο τύπου folder!";

            elseif($err==2)

                $err="Δεν υπάρχει χρήστης με αυτό το email!";

            else

                $err="Επιτυχής Αποστολή Αιτήματος";
    ...
    //ean den exei kanei ton stelnoume stin selida tis eisodou
...
kai pairnei ton arithmo tis grammis gia mellontiki euresi tou stoixeiou pou epelekse-->
...
<script> 
      ...
      /* scriptaki to opoio kaleitai otan patame to koumpi dimiourgia fakelou to opoio emfanizei ena promt parathuro gia na eisagei o xristis

        to onoma tou fakelou pou thelei na dimiourgisei kai kalei tin selida php pou periexei tin ektelesi autis tis leitourgias pairnontas 

        mesw tou url dedomena */
    ...
    function Create() {
     ...
     /* scriptaki to opoio kaleitai otan patame to koumpi rename to opoio emfanizei ena promt parathuro gia na eisagei o xristis
	...
	function Rename() {
       ...
       /* scriptaki to opoio kaleitai otan patame to koumpi delete to opoio kalei tin leitourgia gia tin diagrafi tou arxeiou i fakelou pou epileksame */
	...
	function Delete() {
       ...
       /* scriptaki to opoio kaleitai otan patame to koumpi upload to opoio kalei tin leitourgia gia anevasma arxeiou */
	...
	function Upload() {
      ...
      /* scriptaki to opoio kaleitai otan patame to koumpi share to opoio kalei tin leitourgia gia diamoirasmo fakelou */
    ...
    /* scriptaki to opoio kaleitai otan patame to koumpi pending to opoio kalei emfanizei ti selida i opoia periexei tis aitiseis gia sharing */
...
<!-- emfanisi twn koumpiwn gia kafe leitourgia pou mporei na ektelesei o xristis -->
...
<input type="submit" value="0" name="submission" id="row" style="color: transparent; background-color: transparent; border: 0px;"><input type="submit" value="<?php echo $err; ?>" name="submission" style="color: red; background-color: transparent; border: 0px;">
...
<table class="tbl2" id="mytable" align="center">
...

		{
            ...
            //ama patisei panw sto fakelo o xristis metaferetai se alli selida i opoia emfanizei ta periexomena tou fakelou
			...
			//euresi tou sunolikou megethous tou fakelou athroizontas ola ta megethi arxeiwn pou periexontai se auton
...

		{
            ...
            //ean patisei o xristis panw sto arxeio to katevazei
