...
//elegxos ama o xristis patise eisodo i dimiourgia xristi
if ( $_POST["submission"] == "LogIn")
{
	$email=$_POST["email"];
	$pass=$_POST["password"];
...
// ama o xristis patise na kanei dimiourgia logariasmou metafora tou stin katallili selida
else
